...
```sh
npx shadcnui@latest add breadcrumb calendar card checkbox dropdown-menu input label popover scroll-area select separator table textarea toast skeleton
```
...
```sh
npm i react-dom leaflet react-leaflet
```
